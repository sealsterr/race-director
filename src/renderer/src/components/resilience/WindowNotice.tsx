...
> = {
  ...
  success: {
    ...
    buttonClass: 'border-rd-success/35 bg-rd-success/12 text-rd-success hover:bg-rd-success/20'
  },
  warning: {
    icon: <TriangleAlert size={18} />,
    iconClass: 'bg-rd-warning/16 text-rd-warning',
    panelClass: 'border-rd-warning/25 bg-rd-surface/94',
    buttonClass: 'border-rd-warning/35 bg-rd-warning/12 text-rd-warning hover:bg-rd-warning/20'
  },
  error: {
    icon: <AlertTriangle size={18} />,
    iconClass: 'bg-rd-error/16 text-rd-error',
    panelClass: 'border-rd-error/25 bg-rd-surface/94',
    buttonClass: 'border-rd-error/35 bg-rd-error/12 text-rd-error hover:bg-rd-error/20'
  }
}
    ...
    >
      <div className="flex items-start gap-3">
        ...
        <div className="min-w-0 flex-1">
          <h2 className="rd-wrap text-base font-semibold text-rd-text sm:text-lg">{title}</h2>
          <p className="rd-wrap mt-1 text-sm leading-6 text-rd-muted">{description}</p>
