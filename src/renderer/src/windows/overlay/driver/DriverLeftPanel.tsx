    ...
    return (
        <div style={{ display: "flex", height: "100%", flexDirection: "column", gap: 10 }}>
            ...
            >
                ...
                >
                    {showPosition && (
                        <MetricCell label="POS" value={`P${position}`} />
                    )}
                    <span
                        style={{
                            alignSelf: "stretch",
            ...
            {(showClass || showBestLap) && (
                ...
                >
                    <div style={{ display: "flex", minHeight: 0, flex: 1, flexDirection: "column", justifyContent: "flex-start" }}>
                        {showClass && (
                            <>
                                <div style={labelStyle}>CLASS</div>
                                <div style={{ ...valueStyle, marginTop: 8, fontSize: 20, color: accent }}>{carClass}</div>
                            </>
                        )}
                    </div>
                    <span
