              ...
              <div>
                <div style={{ display: 'flex', justifyContent: 'space-between', gap: 16 }}>
                  ...
                  <div style={{ display: 'flex', gap: 10 }}>
                    <MetricBadge
                      label="LAST LAP"
                      value={formatLapTime(driver.lastLapTime)}
                      width={114}
                    />
                    <MetricBadge
                      label="BEST LAP"
                      value={formatLapTime(driver.bestLapTime)}
                      width={114}
                    />
                  </div>
                </div>
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 7 }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', gap: 8 }}>
        ...
        <span style={{ fontSize: 12, fontWeight: 700, color: accent ? '#ef4444' : '#f2a93c' }}>
          SET
        </span>
      </div>
      <div
