...
export const validateConnectionFields = (
  ...
  if (parsedPollRate === null) {
    return {
      apiUrl,
      pollRate: DEFAULT_POLL_RATE_MS,
      errorMessage: "Poll rate must be a whole number in milliseconds.",
    };
  }
...
export const getConnectionStatusValue = (
...
export const getConnectionButtonClass = (
  connection: ConnectionStatus
): string => {
...
export const getConnectionButtonLabel = (
  connection: ConnectionStatus
): string => {
