...
const TRANSLATIONS: Record<AppLanguage, Record<TranslationKey, string>> = {
  en: {
    ...
    'settings.theme.palette.label': 'App theme',
    'settings.theme.palette.description':
      'Choose a complete color theme for backgrounds, surfaces, accents, and window chrome.',
  ...
  fr: {
    ...
    'settings.theme.palette.label': 'Theme',
    'settings.theme.palette.description':
      'Choisissez un theme complet pour les arriere-plans, les surfaces, les accents et les fenetres.',
  ...
  de: {
    ...
    'settings.theme.palette.label': 'Design',
    'settings.theme.palette.description':
      'Waehle ein komplettes Farbschema fuer Hintergruende, Flaechen, Akzente und Fenster.',
